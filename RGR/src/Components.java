 ...
 */
	 ...
	 * @param x Начальная точка местонахождения лейбла по абсциссе относительно левого верхнего угла панели
	 * @param y Начальная точка местонахождения лейбла по ординате относительно левого верхнего угла панели
	...
	/**
	 * Метод, создающий и возвращающий текстовое поле на основе переданных ему параметров
	 * @param x Начальная точка местонахождения текстового поля по абсциссе относительно левого верхнего угла панели
	 * @param y Начальная точка местонахождения текстового поля по ординате относительно левого верхнего угла панели
	...
	/**
	 * Метод, создающий и применяющий свободный способ расположения элементов к панели
	 * @return Возвращаемая панели
	 */
	 ...
	 * @param x Начальная точка местонахождения чекбокса по абсциссе относительно левого верхнего угла панели
	 * @param y Начальная точка местонахождения чекбокса по ординате относительно левого верхнего угла панели
	...
	/**
	 * Метод, создающий и возвращающий переключатель на основе переданных ему параметров
	 * @param name Надпись переключателя
	 * @param x Начальная точка местонахождения переключателя по абсциссе относительно левого верхнего угла панели
	 * @param y Начальная точка местонахождения переключателя по ординате относительно левого верхнего угла панели
	 ...
	 * @param x Начальная точка местонахождения панели по абсциссе относительно левого верхнего угла фрейма
	 * @param y Начальная точка местонахождения панели по ординате относительно левого верхнего угла фрейма
	 ...
	 * @param x Начальная точка местонахождения кнопки по абсциссе относительно левого верхнего угла панели 
	 * @param y Начальная точка местонахождения кнопки по ординате относительно левого верхнего угла панели 
	 * @param h Ширина кнопки
	 * @param w Высота кнопки
